...
/* BEGIN config */
  ...
  #include <errno.h>
  #include <syscall.h>
/*  Huang Lei, 25Apr13. MACHINE: 8960v5,BCM_96318(MIPS),linux_2.6.30.TP-LINK.
 	If defined this macro, the cloning will return SUCCESS, but no children are actually forked.
 	I don't know the real reason now.Does it not support cloning by "syscall" in embedded MIPS 
 	linux? */
/*
