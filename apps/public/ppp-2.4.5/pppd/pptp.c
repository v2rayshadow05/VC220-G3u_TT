...
void pppopptp_init(void)
{
    ...
    info("PPTP plugin version %s compiled for pppd-%s, linux-%u.%u.%u",
        VERSION, PPPD_VERSION, (LINUX_VERSION_CODE >> 16), (LINUX_VERSION_CODE >> 8) & 0xff, (LINUX_VERSION_CODE & 0xff));
