...
int nslookup_main(int argc, char **argv)
{
	...
	/*modified by xianjiantao for vr600 tt v1*/
	/*i don't know why if the server name is null,it will still try to resolve it,
	result in printing some error message.*/
	if (argv[2])
	server_print();
