...
void pjmedia_endpt_set_mediaPort(pjmedia_endpt * endpt, pj_uint16_t rtp_min_port,pj_uint16_t rtp_max_port)
{
	pj_uint16_t	port;
	port = endpt->mediaPort;
	if (port + 2 >= rtp_max_port)
	{
		port = rtp_min_port;
	}
	else
