...
void pjsua_media_config_default(pjsua_media_config *cfg)
{
    ...
    /* dingcheng-pjsip:initial value for rtp ports */
#ifdef SUPPORT_METABOLIC_MEDIA_PORT
    cfg->rtp_port_lower_bound = PJMEDIA_PORT_LOWER_BOUND;
    cfg->rtp_port_upper_bound = PJMEDIA_PORT_UPPER_BOUND;
#endif
	 #if 0
...
#if defined(INCLUDE_TFC_ES) || defined(INCLUDE_SOL)
