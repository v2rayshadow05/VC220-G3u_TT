...
/*SIP operation*/
	...
	CMSIP_RESPONSE_SIP_SENDREGISTER = 1008, /*Response of sending register package*/
	CMSIP_RESPONSE_SIP_SENDCALLSTATE = 1009, /*send msg about callState*/
}CMSIP_RESPONSE;
...
typedef enum _CMSIP_REG_STATUS
{
	CMSIP_REG_REGISTERING = 1,
	CMSIP_REG_UNREGISTERING = 2,
	CMSIP_REG_ERROR = 3
}CMSIP_REG_STATUS;
/* 
...
typedef enum _CMSIP_SIP_CALLSTATE
{
	CMSIP_CALL_CALLING = 0,
	CMSIP_CALL_RINGING = 1,
	CMSIP_CALL_CONNECTING = 2,
	CMSIP_CALL_INCALL = 3,
	CMSIP_CALL_DISCONNECTING = 4,
	CMSIP_CALL_IDLE = 5
}CMSIP_SIP_CALLSTATE;
