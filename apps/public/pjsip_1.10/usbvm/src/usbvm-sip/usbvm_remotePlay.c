...
{
/* { {20, 30, 8}, RTP_PAYLOAD_G7231_53,  USBVM_CODEC_G7231_53 },
*/
	{ {24, 30, 8}, RTP_PAYLOAD_G7231_63,  USBVM_CODEC_G7231_63 },
	{ {10, 5,  8}, RTP_PAYLOAD_G726_16,   USBVM_CODEC_G726_16  },
	{ {15, 5,  8}, RTP_PAYLOAD_G726_24,   USBVM_CODEC_G726_24  },
	{ {20, 5,  8}, RTP_PAYLOAD_G726_32,   USBVM_CODEC_G726_32  },
	{ {25, 5,  8}, RTP_PAYLOAD_G726_40,   USBVM_CODEC_G726_40  },
	{ {10, 10, 8}, RTP_PAYLOAD_G729A,     USBVM_CODEC_G729A    },
	{ {10, 10, 8}, RTP_PAYLOAD_G729,      USBVM_CODEC_G729	 },     
	{ {40, 5,  8}, RTP_PAYLOAD_PCMU,      USBVM_CODEC_PCMU     },
	{ {40, 5,  8}, RTP_PAYLOAD_PCMA,      USBVM_CODEC_PCMA     },
	{ {0,  0,  0}, RTP_PAYLOAD_NULL,      USBVM_CODEC_NULL     }    /* end of list */
};
			...
			case REMOTE_RECORD_START_NOTIFY:
				{
					if (bFirstRecordStart)
					{
						...
						{
							if (dtmfNum == USBVM_RTP_NTE_DTMFS)
							{
			...
			case REMOTE_RECORD:
				{
					...
					if (dtmf_FIFOGet(g_usbvm_recordHandle[recordId].cnxId, &dtmfNum) == TRUE)
					{
						if (dtmfNum == USBVM_RTP_NTE_DTMFH)
						{
							/* Edited by [Huang Lei], [07Nov12] */
							g_usbvm_recordHandle[recordId].cngSend =FALSE;
							/* Edited End */
			...
			case REMOTE_PINVALIDATE:
				{
					if (dtmf_FIFOGet(g_usbvm_recordHandle[recordId].cnxId, &dtmfNum) == TRUE)
					{
						...
						else if ((dtmfNum <= USBVM_RTP_NTE_DTMF9) && (dtmfNum >= USBVM_RTP_NTE_DTMF0))
						{
...
/* 
 * fn		BOOL usbvm_getPayloadTypeByCodec( USBVM_CODEC_TYPE eptCodec, unsigned int *rtpPayLoadType )
 ...
 * note		
 */
BOOL usbvm_getPayloadTypeByCodec( USBVM_CODEC_TYPE eptCodec, unsigned int *rtpPayLoadType )
{
	int  i = 0;
	BOOL formatMatch = FALSE;
