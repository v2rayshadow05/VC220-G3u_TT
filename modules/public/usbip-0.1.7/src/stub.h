...
#if CLIENT > 2
	/*	超时次数大于2，断开连接	modify to 88*/
#define HEARTBEAT_FAILED_TIMES  2
	/*	2s	一个心跳包 */
#define HEARTBEAT_INTERVAL      2

#define HEARTBEAT_FIRST_INTER	5
#endif
...
void heartbeat_tx_loop(struct usbip_task *);

/*	hided by tf, 110812
#if CLIENT > 2
void heartbeat_timeout(unsigned long data); // added by tf, 110530
#endif
*/
