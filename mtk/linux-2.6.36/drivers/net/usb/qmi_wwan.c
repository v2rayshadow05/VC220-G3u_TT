...
/*transported from kernel 3.13.7 by LY for LTE, 2014.04.02*/
...
/*transported from kernel 3.13.7 by LY for LTE, 2014.04.02*/
static int eth_prepare_mac_addr_change(struct net_device *dev, void *p);
static int eth_prepare_mac_addr_change(struct net_device *dev, void *p)
{
...
static struct usb_driver qmi_wwan_driver = {
	...
	/*
	.disable_hub_initiated_lpm = 1,	//modified by LY for LTE, 2014.04.02
	*/
};
