...
{	
	...
	/*MAC_FLASH_START defined in ../../global_inc/flash_api.h*/
	if (spiflash_ioctl_read(pMac, MAC_FLASH_START, 6) != 0)
	{
		return -1;
	}
...
#else
	/*RADIO_2G_FLASH_START defined in ../../global_inc/flash_api.h*/
	if (spiflash_ioctl_read(calData_2g, RADIO_2G_FLASH_START, 2) != 0)
	{
		return -1;
	}
