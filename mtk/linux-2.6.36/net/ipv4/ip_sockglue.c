...
#if defined(TCSUPPORT_IGMP_QOS) || defined(TCSUPPORT_CT_DNSBIND) || defined(INCLUDE_TTNET) || defined(INCLUDE_IGMP_FASTLEAVE)
...
{
#if defined(INCLUDE_TTNET) || defined(INCLUDE_IGMP_FASTLEAVE)
	struct net_device * dev = dev_get_by_name(&init_net, skb->orig_dev_name);
	__u32 skb_mark = dev ? dev->ifindex : 0;
#else
