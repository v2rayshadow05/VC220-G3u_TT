...
#ifdef CONFIG_IPV6_ROUTER_WAN_SLAAC 			/* Add by CM 2019-10-17 for TTNET VC220 node X_TT_IPv6_AFlag */ 
	in6_dev->cnf.if_flags &= 0xFF;
	in6_dev->cnf.if_flags |= (((pinfo->onlink << 1)|(pinfo->autoconf))<<8);
#endif
