...
#define ATM_ADDEXTBACKENDIF _IOW('a',ATMIOC_SPECIAL+7,atm_backend_t)
#define ATM_DELEXTBACKENDIF _IOW('a',ATMIOC_SPECIAL+8,atm_backend_t)
#define ATM_ATTACHBACKEND	_IOW('a',ATMIOC_SPECIAL+9,atm_backend_t)
#define ATM_SHOWBACKENDIF	_IOW('a',ATMIOC_SPECIAL+10,atm_backend_t)
#endif
