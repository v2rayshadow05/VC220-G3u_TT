...
typedef struct PACKED _DOT1X_CMM_CONF
{
	...
	unsigned int		session_timeout_interval[MAX_MBSSID_NUM];
...
void ieee802_1x_new_station(struct apd_data *apd, struct sta_info *sta);
void ieee802_1x_free_station(struct sta_info *sta);

void ieee802_1x_request_identity(struct apd_data *apd, struct sta_info *sta, u8 id);
void ieee802_1x_tx_canned_eap(struct apd_data *apd, struct sta_info *sta, u8 id, int success);
void ieee802_1x_tx_req(struct apd_data *apd, struct sta_info *sta, u8 id);
void ieee802_1x_tx_key(struct apd_data *hapd, struct sta_info *sta, u8 id);
void ieee802_1x_send_resp_to_server(struct apd_data *apd, struct sta_info *sta);
void ieee802_1x_set_sta_authorized(struct apd_data *rtapd, struct sta_info *sta, int authorized);
int ieee802_1x_init(struct apd_data *apd);
void ieee802_1x_new_auth_session(struct apd_data *apd, struct sta_info *sta);
