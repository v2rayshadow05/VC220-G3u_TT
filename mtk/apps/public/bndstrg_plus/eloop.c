...
void eloop_run(void)
{
	...
	while (!eloop.terminate &&
		...
		TP_DBG("eloop.readers.count:%d, writers.count:%d, exceptions.count:%d, terminates:%d",
			eloop.readers.count, eloop.writers.count, eloop.exceptions.count, eloop.terminate);
	}
out:
	TP_DBG("end!!");
	os_free(rfds);
