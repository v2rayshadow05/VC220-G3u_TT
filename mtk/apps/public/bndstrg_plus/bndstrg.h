...
#define BND_STRG_MAX_TABLE_SIZE	255
#else
//#define BND_STRG_MAX_TABLE_SIZE	(64*3)
#define BND_STRG_MAX_TABLE_SIZE	200
#endif
...
#define BND_STRG_CHANLOAD_THR_5GH	80
#define BND_STRG_CHANLOAD_THR_5GL	80
...
#define IDLE_RXTX_BYTE_COUNT	1024
#ifdef TCSUPPORT_WLAN_BNDSTRG_CUSTOM2
#define ENTRY_BACKUP_TIME 		1 //FPT 0615 modify	
#else
...
#ifdef TCSUPPORT_WLAN_BNDSTRG_CUSTOM2
#define BLACK_LIST_TIME			1 //FPT 0615 modify	one is enough, since it's counting downing after  ENTRY_BACKUP_TIME
#endif
#ifdef VENDOR_FEATURE7_SUPPORT
...
enum BND_STRG_PRIORITY_FLAGS {
	...
	fBND_STRG_PRIORITY_5G_NUM_LIMIT_PRE			,	//add by yp
#endif
...
#ifdef LIMIT_5G_NUM_SUPPORT
	fBND_STRG_PRIORITY_5G_NUM_LIMIT_POST	,   //add by yp
#endif
#ifdef VENDOR_IOS_SUPPORT
...
#endif
	fBND_STRG_PRIORITY_FAST_FORWARD,
...
#else
#ifdef TCSUPPORT_WLAN_BNDSTRG_CUSTOM2
	u8				BlackListTimer; // FPT 0615 modify
#endif
#endif
#ifdef WPS_SUPPORT
...
struct bndstrg_cli_table {
	...
	u8      DetectInterval;    // added by huaming
	u32     IdleThreshold;     // added by huaming
#endif
#ifdef	VENDOR_IOS_SUPPORT
	u8		IOSNumLimit;
#endif
...
#ifdef VENDOR_IOS_SUPPORT
	u8 bIosCapable;   //20180309, For IOS immediately connect
#endif
	u8	bVHTCapable;
	u8	Nss;
	signed char	Rssi[4];
